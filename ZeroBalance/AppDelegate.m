...
- (void)applicationWillTerminate:(UIApplication *)application {
    ...
    NSError *error = nil;
    if ([[[self dataController] managedObjectContext] hasChanges] && ![[[self dataController] managedObjectContext] save:&error]) {
...
//            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"ZeroBalance"];
